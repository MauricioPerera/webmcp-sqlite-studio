...
export const TRANSLATIONS: Record<Language, TranslationData> = {
  es: {
    ...
    toolsSection: {
      ...
      tool1Name: "db_execute_query",
      tool1Desc: "Ejecuta cualquier sentencia SQL (SELECT, INSERT, UPDATE, DELETE, DDL) con rollback transaccional automático en caso de fallo.",
      tool2Name: "db_list_tables",
      tool2Desc: "Descubre dinámicamente todas las tablas, vistas del sistema y conteo de registros en tiempo real.",
      tool3Name: "db_describe_table",
      tool3Desc: "Inspecciona a fondo el esquema: nombres de columnas, tipos de datos, llaves primarias y restricciones NOT NULL.",
      ...
      tool6Name: "db_get_stats",
      tool6Desc: "Audita el estado del motor WASM: memoria consumida, páginas activas, tablas totales y tamaño estimado.",
      tool7Name: "db_optimize",
      tool7Desc: "Aplica mantenimiento de alto rendimiento: ejecuta VACUUM, ANALYZE y verificaciones de integridad PRAGMA.",
  ...
  en: {
    ...
    toolsSection: {
      ...
      tool1Name: "db_execute_query",
      tool1Desc: "Execute any SQL query (SELECT, INSERT, UPDATE, DELETE, DDL) with automatic transactional rollback upon error.",
      tool2Name: "db_list_tables",
      tool2Desc: "Dynamically discover all database tables, system views, and real-time record counts.",
      tool3Name: "db_describe_table",
      tool3Desc: "Thoroughly inspect schemas: column names, data types, primary keys, and NOT NULL constraints.",
      tool4Name: "db_import_json",
      tool4Desc: "Ingest JSON arrays with automated schema inference and datatype detection (INTEGER, REAL, TEXT).",
      tool5Name: "db_export_json",
      tool5Desc: "Extract any query or full table into clean, structured JSON ready for LLM reasoning and processing.",
      tool6Name: "db_get_stats",
      tool6Desc: "Audit WASM engine vitals: allocated memory footprint, active pages, total tables, and estimated database size.",
      tool7Name: "db_optimize",
      tool7Desc: "Run high-performance maintenance: trigger VACUUM, ANALYZE, and PRAGMA integrity verification in memory.",
  ...
  pt: {
    ...
    toolsSection: {
      ...
      tool1Name: "db_execute_query",
      tool1Desc: "Executa qualquer consulta SQL (SELECT, INSERT, UPDATE, DELETE, DDL) com rollback transacional automático em caso de erro.",
      tool2Name: "db_list_tables",
      tool2Desc: "Descobre dinamicamente todas as tabelas, views do sistema e contagem de registros em tempo real.",
      tool3Name: "db_describe_table",
      tool3Desc: "Inspeciona minuciosamente o esquema: nomes de colunas, tipos de dados, chaves primárias e restrições NOT NULL.",
      tool4Name: "db_import_json",
      ...
      tool6Name: "db_get_stats",
      tool6Desc: "Audita a saúde do motor WASM: memória consumida, páginas ativas, tabelas totais e tamanho estimado do banco.",
      tool7Name: "db_optimize",
      tool7Desc: "Aplica manutenção de alta performance: executa VACUUM, ANALYZE e verificações de integridade PRAGMA.",
